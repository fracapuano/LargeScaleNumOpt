function [xk, fk, k, grads_out, values_out] = hybrid_PKplus_Newton(...
...
[xk, fk, ~, k_N, grads_N, values_N] = h_innewton_general(xk, f, gradf, Hessf, kmax-k_start, ...
