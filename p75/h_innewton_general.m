function [xk, fk, gradfk_norm, k, grads, values, inner_its] = h_innewton_general(x0, f, gradf, Hessf, kmax, ...
...
while k < kmax && gradfk_norm >= tolgrad
    ...
    [pk, ~, ~, its] = gmres(Hessf_computed, -gradfk, floor(sqrt(n)), epsilon_k, pcg_maxit);
