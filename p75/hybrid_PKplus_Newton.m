function [xk, fk, k, k_start, grads_out, values_out, inner_its] = hybrid_PKplus_Newton(...
    x0, f, gradf, Hessf, kmax, tolgrad, c1, rho, btmax, fterms, pcg_maxit, perc)
...
[xk, fk, ~, k_N, grads_N, values_N, inner_its] = h_innewton_general(xk, f, gradf, Hessf, kmax - k_start, ...
